...
export default function Button_Save_Delete({ user, savePP }: any) {
  ...
  return (
    <>
      <span className=" border-0 w-[50px] h-[50px]  flex items-center space-x-4 ">
        <CiEdit
          className="h-[30px] w-[30px] text-gray-50 group-hover:text-green-400 hover:text-red-400 hover:cursor-pointer"
